  ...
  if (!classe) {
    return (
      <Shell subtitle="Chamada">
        <Card>
          <p className="text-sm text-muted-foreground">Nenhuma classe selecionada.</p>
    ...
    >
      <div className="grid gap-4 lg:grid-cols-3">
        <Card className="lg:col-span-2">
          ...
          <ul className="mt-2 divide-y divide-border">
            ...
            {classStudents.length === 0 ? (
              <li className="py-2 text-sm text-muted-foreground">Nenhum aluno cadastrado nesta classe.</li>
            ) : null}
          </ul>
        ...
        <div className="space-y-4">
          ...
          <Card>
            <p className="text-sm text-muted-foreground">Total de presentes na classe</p>
